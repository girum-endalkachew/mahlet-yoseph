      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 bg-[#362A24] text-[#E7DED5]">
        <div className="relative min-h-[480px] md:min-h-[560px] overflow-hidden group">
          ...
          <div className="relative z-10 h-full p-8 md:p-16 flex flex-col justify-center max-w-lg">
            ...
            <p className="mt-5 text-[11px] tracking-[0.3em] uppercase text-[#E7DED5]/80">Mahlet Yoseph</p>
            <p className="text-[9px] tracking-[0.35em] text-[#C8A86A] mt-1 italic">The Art of Strength</p>
            <Link
              href="/collections"
        ...
        <div className="p-8 md:p-16 border-t lg:border-t-0 lg:border-l border-[#8E786F]/25 flex flex-col justify-between min-h-[480px]">
          <div className="text-center pb-10 border-b border-[#8E786F]/25">
            <p className="font-serif text-4xl tracking-[0.35em]">MY</p>
            <p className="text-[10px] tracking-[0.35em] uppercase mt-3">Mahlet Yoseph</p>
            <p className="text-[8px] tracking-[0.4em] text-[#C8A86A] mt-2">The Art of Strength</p>
            <div className="gold-line mt-8 mx-auto w-32" />
          </div>

          <div className="grid grid-cols-3 gap-4 py-10 text-[9px] sm:text-[10px] tracking-[0.22em] uppercase">
          ...
          <div className="pt-6 border-t border-[#8E786F]/25 flex flex-col sm:flex-row justify-between gap-3 text-[8px] sm:text-[9px] tracking-[0.25em] text-[#8E786F]">

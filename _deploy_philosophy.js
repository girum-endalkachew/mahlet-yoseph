...
// ===== 2. UPDATED NAVBAR WITH PHILOSOPHY =====
...
// ===== 3. HOMEPAGE — UPDATED HERO + PHILOSOPHY TEASER =====
    ...
    <main className="w-full bg-[#E7DED5] min-h-screen text-[#4A3D37] overflow-x-hidden">
      ...
      <section className="relative w-full h-[100svh] min-h-[640px] bg-[#5C4D45] overflow-hidden flex flex-col justify-between">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#362A24]/60 via-[#5C4D45]/25 to-[#362A24]/80" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#362A24]/55 via-transparent to-[#362A24]/45" />
          <div className="absolute inset-0 grain" />
        </div>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center px-6 sm:px-10 md:px-16 pt-24 pb-10">
          <div className="max-w-[1600px] mx-auto w-full grid lg:grid-cols-2 gap-10 items-end">
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.25, ease: "easeOut" }} className="hidden lg:block text-right text-[#E7DED5]">
              ...
              <p className="mt-6 text-sm font-light text-[#E7DED5]/70 max-w-sm ml-auto leading-relaxed">
        ...
        <div className="relative z-10 px-6 sm:px-10 md:px-16 pb-8 flex justify-between items-end text-[#E7DED5]/60 text-[10px] tracking-[0.3em] uppercase">
      ...
      <section className="relative py-24 md:py-32 px-6 text-center overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <Image src="/images/philosophy/bg.jpg" alt="Philosophy" fill className="object-cover" sizes="100vw" />
...
console.log("\\n🎉 Philosophy page, Hero update, Nav update, and Teaser all deployed!");
console.log("\\nTest:");
console.log("  / — Hero with WEAR YOUR STRENGTH + sequential beats");
console.log("  / — Philosophy teaser section with dark bg");
console.log("  /philosophy — Full dedicated page");
console.log("  Nav — Philosophy link in desktop + mobile menu");
